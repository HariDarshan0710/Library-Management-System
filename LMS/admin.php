...
<body background="a.jpg">
	<div id="banner">
		...
		<marquee class="clg" direction="right" behavior="alternate" scrollamount="2">Mini Project team Hari and Mukul</marquee>
	</div>
	<br />
			...
			<form method="post" action="">
				<table border="0" cellpadding="4" cellspacing="4" class="table">
					...
					<tr>
						...
						<td><input type="text" name="aid" class="fields" size="25" placeholder="Enter Admin ID"
								required="required" /></td>
					</tr>
					<tr>
						<td class="labels">Password : </td>
						<td><input type="password" name="pass" class="fields" size="25" placeholder="Enter Password"
								required="required" /></td>
					</tr>
					<tr>
